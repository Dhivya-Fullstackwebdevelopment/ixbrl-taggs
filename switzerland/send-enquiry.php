...
$FROM_NAME  = 'XBRtags Switzerland';
$TO_EMAIL   = 'sarjun@psdigitise.com';   // <-- where new enquiries land
$TO_NAME    = 'XBRtags Team';

// Used if a page forgets to send a region (or for this Switzerland deployment
...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS enquiries (
        ...
        region VARCHAR(50) NOT NULL DEFAULT 'Switzerland',
    ...
    try {
        $pdo->exec("ALTER TABLE enquiries ADD COLUMN region VARCHAR(50) NOT NULL DEFAULT 'Switzerland' AFTER form_type");
