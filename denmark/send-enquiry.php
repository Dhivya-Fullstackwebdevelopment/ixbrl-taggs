 ...
 * shared across the Denmark, Denmark and Switzerland pages (region field).
 * 1. Validates input
...
$region     = clean_input($_POST['region'] ?? '') ?: $DEFAULT_REGION; // Denmark / Denmark / Switzerland
...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS enquiries (
        ...
        region VARCHAR(50) NOT NULL DEFAULT 'Denmark',
    ...
    try {
        $pdo->exec("ALTER TABLE enquiries ADD COLUMN region VARCHAR(50) NOT NULL DEFAULT 'Denmark' AFTER form_type");
